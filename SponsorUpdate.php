...
if (!$db_selected) {
	...
	$intSponsorID = $_POST["intSponsorID"];
...
//Update updateSponsor  break point - Success?
	if (!mysqli_query($link, $updateSponsor)) {
		die('Error: updateSponsor' . mysqli_error($link));
	}


	header("Location: /WAPP1-CichonN/Content/Week13/ShowSponsors.php");
