...
if (!$db_selected) {
	...
	printf ("<h2>Team Donor List - %s</h2>", $Team);
	...
	$sql = "
		SELECT TEventGolferSponsors.IntSponsorID
				...
				FROM TEventGolferSponsors 
				 ...
				 WHERE (SELECT CONCAT(TTypesOfTeams.strTypeOfTeam, ' ', TLevelOfTeams.strLevelOfTeam, ' ', TGenders.strGender) AS Team ) = '$Team';";
...
?>
	...
	<br>
	<button style="display: block; margin: auto;"r onclick="location.href = '/WAPP1-CichonN/Content/Week13/TeamStatistics.php';">Go Back</button></a>
